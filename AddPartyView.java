...
public class AddPartyView implements ActionListener, ListSelectionListener {
	...
	public AddPartyView(ControlDeskView controlDesk, int max) {
		...
		win = Components.createJFrame("Add Party");

		JPanel colPanel = new JPanel();
		colPanel.setLayout(new GridLayout(1, 3));

		// Party Panel
		JPanel partyPanel = Components.createJPanel("Your Party");
		...
		// Bowler Database
		JPanel bowlerPanel = Components.createJPanel("Bowler Database");
		...
		// Button Panel
		JPanel buttonPanel = Components.createJPanel(4,1,"");

		addPatron = Components.createJButton("Add to Party", buttonPanel);
		addPatron.addActionListener(this);

		remPatron = Components.createJButton("Remove Member", buttonPanel);
		remPatron.addActionListener(this);

		newPatron = Components.createJButton("New Patron", buttonPanel);
		newPatron.addActionListener(this);

		finished = Components.createJButton("Finished", buttonPanel);
